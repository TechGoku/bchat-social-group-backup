...
def send_inbox(sid):
    """
    Delivers a direct message to a user via their blinded Bchat ID.
    ...
    404 Not Found — if the given Bchat ID does not exist on this server, either because they have
