...
def handle_v3_onionreq_plaintext(body):
    ...
    - "/legacy/" will be prepended to the endpoint.  E.g. "endpoint":"rooms/ROOM/image" goes to the
      "/legacy/rooms/ROOM/image" endpoint in pybsgs.
    ...
    try:
        ...
        if method in http.BODY_METHODS:
            ...
            subreq_body = None
            # Android bug workaround: Android Bchat (at least up to v1.11.12) sends a body on
...
def handle_v4_onionreq_plaintext(body):
    ...
    The "headers" field typically carries X-BSGS-* authentication headers as well as fields like
...
@onion_request.post("/beldex/v3/lsrpc")
@onion_request.post("/beldex/v3/lsrpc")
...
@onion_request.post("/beldex/v4/lsrpc")
