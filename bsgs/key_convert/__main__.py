...
parser = argparse.ArgumentParser(
    description="Convert old bchat-social-group-server key format to new key format"
)
parser.add_argument(
    "--in",
    "-i",
    ...
    help="Path to the bchat-social-group-server key file",
...
parser.add_argument(
    ...
    help="Path to the new bsgs key to write",
    default='./key_x25519',
)
