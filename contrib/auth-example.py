...
# Example script for demonstrating X-BSGS-* authentication calculation.
...
def get_signing_headers(
    ...
    if blinded:
        ...
        # For unblinded auth we send our *ed25519* master pubkey in the X-BSGS-Pubkey header with a
        # 'bd' prefix to disambiguate it; the BSGS server will convert it to X25519 to derive our
        # X25519 bchat id.
        pubkey = 'bd' + s.verify_key.encode().hex()
    ...
    return {
        ...
        'X-BSGS-Nonce': b64encode(nonce).decode(),
        'X-BSGS-Signature': b64encode(sig).decode(),
    }
...
Bchat ID: bd{s.to_curve25519_private_key().public_key.encode().hex()}
Server X25519 pubkey: {B.hex()}
Blinded Bchat ID (for this server): 15{blinded_ed25519_keys(B, s)[1].hex()}
Request: {method} {path}
""",
    file=sys.stderr,
)
...
# Prints:
# Unblinded headers:
# X-BSGS-Pubkey: 00bac6e71efd7dfa4a83c98ed24f254ab2c267f9ccdb172a5280a0444ad24e89cc
# X-BSGS-Timestamp: 1642472103
# X-BSGS-Nonce: CdB5nyKVmQGCw6s0Bvv8Ww==
# X-BSGS-Signature: xxLpXHbomAJMB9AtGMyqvBsXrdd2040y+Ol/IKzElWfKJa3EYZRv1GLO6CTLhrDFUwVQe8PPltyGs54Kd7O5Cg==   # noqa E501
#
# Blinded headers:
# X-BSGS-Pubkey: 1598932d4bccbe595a8789d7eb1629cefc483a0eaddc7e20e8fe5c771efafd9af5
# X-BSGS-Timestamp: 1642472103
# X-BSGS-Nonce: CdB5nyKVmQGCw6s0Bvv8Ww==
# X-BSGS-Signature: gYqpWZX6fnF4Gb2xQM3xaXs0WIYEI49+B8q4mUUEg8Rw0ObaHUWfoWjMHMArAtP9QlORfiydsKWz1o6zdPVeCQ==  # noqa E501
